...
@onready var enter_music = preload("res://scn/enemy/skeleton/base/enter.wav")
@onready var cry_music = preload("res://scn/enemy/skeleton/base/cry.wav")
...
func hurt(damage):
	...
	if(health <= 0):
		...
		Global.game_difficulty.monster_num -= 1
